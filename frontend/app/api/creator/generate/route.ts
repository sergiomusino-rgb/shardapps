...
async function callSiteSchemaGenerator(
  ...
  const systemPrompt = `Sei ZeusX AI, un architetto di siti web e PWA per piccole attività. Genera uno schema JSON per un progetto di tipo "${projectType}" in lingua ${lang}.
