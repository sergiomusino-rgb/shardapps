...
// ═══════════════════════════════════════════════════════════════════════════
// LoginClient (outer, wraps LoginForm in Suspense) — rinominato da LoginPage
// nel pre-launch hardening: app/login/page.tsx è ora un Server Component
// che esporta solo `metadata` e renderizza questo componente invariato.
// ═══════════════════════════════════════════════════════════════════════════
